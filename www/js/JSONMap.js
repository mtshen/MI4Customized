...
const MI4ParseJSONMapElements = {
  ...
  'Date.MonthAndDay.Separate.Month': {
    type: 2, images: ['021', '022', '023', '024', '025', '026', '027', '028', '029', '030'], title: '月份', repeat: 2,
  },
  'Date.MonthAndDay.Separate.Day': {
    type: 2, images: ['021', '022', '023', '024', '025', '026', '027', '028', '029', '030'], title: '日期', repeat: 2,
  },
  'Date.WeekDay': {
  ...
  'Battery.Text.Number': {
    type: 2, images: ['011', '012', '013', '014', '015', '016', '017', '018', '019', '020'], title: '剩余电量', repeat: 2,
  },
  'Battery.Icon': {
    type: 0, images: ['051', '052', '053', '054', '055'], title: '电池图标',
  },
  'StepsProgress.Linear.Segments': {
    type: 3, images: ['038', '039', '040', '041', '042', '043', '044', '045', '046', '047'], title: '??? 不知何物',
  }
};
